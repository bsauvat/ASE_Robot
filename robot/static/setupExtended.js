...
export const setupConfigExtended = () => {
    ...
    const textmateConfigUrl = new URL('../syntaxes/rbot.tmLanguage.json', window.location.href);
    extensionFilesOrContents.set('/language-configuration.json', languageConfigUrl);
    extensionFilesOrContents.set('/rbot-grammar.json', textmateConfigUrl);
                ...
                extensions: [{
                    config: {
                        ...
                        contributes: {
                            ...
                            grammars: [{
                                language: 'rbot',
                                scopeName: 'source.rbot',
                                path: './rbot-grammar.json'
                            }]
                        }
                    },
